...
<head>
    ...
    <meta charset="utf-8" />
    <title>intellithesis | intellithesis - Admin & Dashboard Template</title>
                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <form class="my-4" action="{{ route('register-user') }}" method="POST">
                                        @csrf
                                            ...
                                            <div class="col-12">
                                                <div class="form-check form-switch form-switch-success">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="customSwitchSuccess" name="terms">
                                                    <label class="form-check-label" for="customSwitchSuccess">By
                                                        registering you agree to the intellithesis <a href="#"
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted">Already have an account ? <a href="auth-login"
